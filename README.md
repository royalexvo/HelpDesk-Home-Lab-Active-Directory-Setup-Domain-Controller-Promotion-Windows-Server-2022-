...
<h2>Description</h2>
This lab documents the installation of Windows Server 2022 in a virtual environment using Oracle VirtualBox. The goal of this Lab is to create a basic help desk lab environment that will be used for future Active Directory, domain configuration,<br><br>
...
- <b>Create a new domain/forest</b>
- <b>Validate the installation</b>

This builds on the previous lab where the virtual machine and Windows Server were installed.
<br />
...
<img src="https://github.com/royalexvo/Helpdesk-Ho1me-Lab-Windows-Server-2022-Installation-Virtual-Environment-Setup/blob/main/Step%2012.png?raw=true" height="80%" width="80%" alt="Lab Steps"/>
</p>
